...
//!
//! Optional, additive cash-account spending tracking. Sibling crate to
...
//! - Cash accounts already participate in net worth via the existing snapshot pipeline.
...
//! - `cash_activities` — query/CRUD for cash-account activities (DEPOSIT/WITHDRAWAL/TRANSFER).
